...
def test_get_weather_is_deterministic() -> None:
    result = get_destination_weather("Paris", ["2026-06-10", "2026-06-11"])
...
def test_search_flights_returns_pricing() -> None:
    result = search_flights("Paris", 2, "economy")
...
def test_search_hotels_returns_info() -> None:
    result = search_hotels("Tokyo", 3, 2, "budget")
...
def test_estimate_trip_cost_marks_budget_status() -> None:
    ...
    result = estimate_trip_cost(plan, days=3, budget_usd=500.0, travelers=2, destination="Paris")
